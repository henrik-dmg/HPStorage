...
public struct FileUtility {
	...
	public init(directory: Directory, options: Options) {
...
public extension FileUtility {
	...
	func removeAllInDirectory(options: FileManager.DirectoryEnumerationOptions = []) throws {
		let baseURL = try directory.makeBaseURL()
		try FileManager.default.removeAllItems(at: baseURL, options: options)
	}
